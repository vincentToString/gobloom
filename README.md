...
- **Zero-allocation hashing**: Custom MurmurHash3 implementation (0 allocs/op) [Copied from bits-and-blooms/bloom repository for learning purpose]
...
func main() {
    ...
    fmt.Println(bf.Verify([]byte("nope")))  // false (reliable) / true(due to false positive)
}
```
